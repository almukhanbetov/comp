 <footer class="bg-[#060a11] border-t border-[rgba(255,107,53,0.12)] relative z-10">
                ...
                <div>
                    ...
                    <div class="space-y-2.5">
                        <a href="tel:+77001234567" class="flex items-center gap-3 group">
                            ...
                            <span
                                class="text-sm text-slate-400 group-hover:text-[#ff6b35] transition-colors font-mono">+7
                                700 123-45-67</span>
                        </a>
                        <a href="https://wa.me/77001234567" class="flex items-center gap-3 group">
                            <div
                ...
                <div>
                    ...
                    <div class="inline-flex flex-col items-start">
                        <div
                            ...
                            <svg viewBox="0 0 210 210" width="156" height="156"
                                ...
                                <g fill="#0a0f1a">
                                    ...
                                    <rect x="98" y="98" width="14" height="14" rx="3"
                                        fill="#ff6b35" />
                                </g>
                            </svg>
                        </div>
        ...
        <div class="border-t border-white/5">
            <div
                ...
                <p class="text-slate-600 text-xs font-mono order-2 sm:order-1">© 2025 Complex Services. Все права
                    защищены.</p>
